...
const Footer = () => {
  return (
    <div className="footer-container  ">
      <div class="flex items-center justify-end sticky top-20 z-[-1]">
        <img src="/Images/footer-bg.jpg" alt="" class="" />
      </div>
      <div className="grid  sm:grid-cols-2 lg2:grid-cols-6 grid-cols-8 pl-2  w-[80%] bg-black sm:w-full">
        <div className="col-span-2 sm:col-span-2 lg2:col-span-2 lg:col-span-2 ">
          <div className="">
            ...
            <p className="mt-[51px]  text-stone-300 sm:text-center">
        ...
        <div className="col-span-2 sm:col-span-2 lg2:col-span-3 lg:col-span-2 bg  row-span-2">
          <div className="flex flex-col items-center justify-evenly text-center  bg-stone-800 pr-2">
            <div>
              <h2 className="font-bold text-4xl mt-[100px] text-stone-300 ">
            ...
            <div className="my-9">
              <Link
                href="/contact"
                className="hover:bg-sky-700 hover:text-white hover:border-sky-700  hover:transition duration-700 ease-in-out flex justify-center 
               
                items-center  my-9 rounded-full h-40 w-40 border-2 text-stone-300 "
              >
                Contact us <span> {<BsArrowUpRight />}</span>
              </Link>
            </div>
            <div className="flex flex-col justify-center items-center">
              <h3 className="text-white font-bold  ">09: 00 AM - 10 : 30 PM</h3>
              <span className="text-stone-300 mb-[40px]">
                Saturday- Thursday
              </span>
            </div>
          </div>
        ...
        <div className="col-span-3 sm:col-span-3 lg2:col-span-3 lg:col-span-3 bg ">
          <div class="flex justify-center items-center h-full lg2:h-20  mx-2">
            <input
              ...
              id="email"
              name="email"
              class="w-full h-[50%] bg-black bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
            />
          </div>
        </div>
      </div>
